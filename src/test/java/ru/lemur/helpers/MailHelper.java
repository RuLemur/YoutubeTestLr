...
//    private int receivingPort;
    ...
    public static void main(String[] args) {
        ...
        String mailFrom = new String("rulemur@gmail.com");
        ...
        String senderUserName = new String("rulemur");
        ...
        mailHelper.setAccountDetails(senderUserName, senderPassword);

        //Send mail

//        mailHelper.sendGmail(mailFrom, mailTo, mailSubject, mailText);

        //Receive mails

        mailHelper.readGmail();
